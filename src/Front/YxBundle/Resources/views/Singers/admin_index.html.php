...
<script type="text/javascript" src="/js/js_files/singer.js"></script>
<div class="PageTitle"><?php echo strtoupper('Performer'); ?></div>
<div id="tasks_todo" >
    <div class="md">
  ...
  <tbody>
    ...
    <tr <?php echo $classVar;?> id="tr_<?php echo $data['id'];?>" >
        ...
        <td><a href="/admin/songs/singer/<?php echo $data['id'];?>"><?php echo $data['sname'];?></a></td>
    </tr>
    <?php endforeach; ?>
...
<table>
    ...
    <td class="buttonbar" align="">
        ...
        &nbsp;&nbsp;
        <a href="/admin/singers/add"><input type="button" value="Add New"></a>
    </td>
</tr> 
</table>
