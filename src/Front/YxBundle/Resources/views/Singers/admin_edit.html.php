...
<div class="PageTitle"><?php echo strtoupper('Edit Performer'); ?></div>
<div id="tasks_todo" >
    <div class="md">
    ...
    <form name="frm1" id="frm1" method="post" action="" enctype="multipart/form-data">
        <div id="tasks_todo">
            <table width="70%" cellpadding="2" cellspacing="0" border="0" align="" class="blue_header borNavBlue">
                ...
                <tr class="bgGrey">
                    <td align="right">Performer Name:</td>
                    <td>
                        <input type="hidden" name="id" value="<?php echo $record->getId(); ?>"/>
                        <input class="required" type="text" size="40" name="sname" value="<?php echo $record->getSname();?>" />
                    </td>
                </tr>
                <tr class="bgGrey">
                    <td align="right"></td>
