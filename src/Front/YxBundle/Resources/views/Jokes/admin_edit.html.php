...
<div class="PageTitle"><?php echo strtoupper('Edit Joke'); ?></div>
<div id="tasks_todo" >
    <div class="md">
        ...
        <div id="tasks_todo">
            <table width="70%" cellpadding="2" cellspacing="0" border="0" align="" class="blue_header borNavBlue">
                        ...
                        <?php
                            if ( $jokeCat ):
                                foreach ( $jokeCat as $val ):
                                    $sel = $val->getId() == $record->getJokecategoryId() ? ' selected ' : '';
                ...
                <tr class="bgGrey">
                    ...
                    <td>
                        <textarea class="required" name="description" rows="5" cols="43"><?php echo $record->getDescription(); ?></textarea>
                    </td>
                </tr>
                <tr class="bgGrey">
                    <td align="right"></td>
