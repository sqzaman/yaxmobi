...
<div class="PageTitle"><?php echo strtoupper('News'); ?></div>
<div id="tasks_todo" >
    <div class="md">
        <?php //echo $this->renderElement('member_search')?>
        <?php //echo $view['actions']->render('YxBundle:Tickers:index', array('flag' => 'reduced'));?>
        <?php echo $view->render('YxBundle:Box:search_bar.html.php', array('url' => $base_url .'/', 'label' => 'News')); ?>
    </div>
...
<table>
    ...
    <td class="buttonbar" align="">
        ...
        &nbsp;&nbsp;
        <a href="/admin/newscontents/add"><input type="button" value="Add New"></a>
    </td>
</tr> 
</table>
