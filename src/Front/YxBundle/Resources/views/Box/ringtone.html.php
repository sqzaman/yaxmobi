		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="2">&nbsp;</td>
					<td width="1"><img src="/img/images/t01.gif" border="0" width="6" height="28" />					</td>
					<td width="10" style="background-image: url(/img/images/t02.gif); background-repeat: repeat-x;">
						<a href="/tabs/ringtone/"  class="navwhitelink change-tab" id="link175492473">Ringtones</a>
                                        </td>
			...
			<td colspan="2" align="center" style="border: #4c4c4c 1px solid;" bgcolor='#bcbcee'>
				...
				<tr>
					...
					<table width="96%" border="0" cellspacing="0" cellpadding="8" bgcolor="#d6d2d2">
						<tr>
						<?php
						for($i=0;$i<=count($ringtonecat)-1;$i++)
						{
							?>
							<td align="center">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											<td bgcolor="#eeeeee">
												<?php
													$ringtonecat[$i]['image'] != '' ? $image = 'ringtonecategory/' . $ringtonecat[$i]['image'] : $image = 'images/blondes.gif'; 
                                                                                                        echo '<a class="pagelink" href="/ringtones/ringtonelist/'. $ringtonecat[$i]['id'] .'"><img src="/img/'.$image.'" border="0" width="65" height="65" /></a>';
												?>
								...
								<tr>
									<td align="center">
										...
										<b><?php echo '<a class="pagelink" href="/ringtones/ringtonelist/'. $ringtonecat[$i]['id'] .'">'.$ringtonecat[$i]['title'].'</a>';?></b>
									</td>
								</tr>
							</table>
							</td>
