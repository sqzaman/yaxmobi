...
<script src="js/jquery/lightbox-2.6.min.js"></script>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="1"><img src="/img/images/t01d.gif" border="0" width="5" height="28" />					</td>
					<td width="10" style="background-image: url(/img/images/t02d.gif); background-repeat: repeat-x;">
						<a href="/tabs/video/"  class="navgraylink change-tab" id="link32783323" >Videos</a></td>
					<td width="1"><img src="/img/images/t03d.gif" border="0" width="6" height="28" />					</td>
                                        <td width="2">&nbsp;</td>
						...
						<a href="/tabs/cartoons/"  class="navwhitelink change-tab" id="link32783323" >Cartoons</a></td>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											<td bgcolor="#eeeeee">
												<?php
													$records[$i]['image'] != '' ? $image = 'cartoons/' . $records[$i]['image'] : $image = 'images/blondes.gif'; 
                                                                                                        echo '<a title="'. $records[$i]['title'] .'" href="img/'.$image.'" data-lightbox="example-1" class="example-image-link"><img class="example-image" src="/img/'.$image.'" border="0" width="65" height="65" /></a>';
												?>
								...
								<tr>
									<td align="center">
										...
										<b><?php echo '<a title="'. $records[$i]['title'] .'" href="img/'.$image.'" data-lightbox="example-2" class="example-image-link">'.$records[$i]['title'].'</a>';?></b>
									</td>
								</tr>
							</table>
							</td>
