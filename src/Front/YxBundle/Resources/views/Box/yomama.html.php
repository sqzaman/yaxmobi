			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="10" style="background-image: url(/img/images/t02.gif); background-repeat: repeat-x;">
						<a href="/tabs/yomama/"  class="navwhitelink change-tab" id="link175492473">Yomama</a>
                                        </td>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											<td bgcolor="#eeeeee">
												<?php
													$records[$i]['image'] != '' ? $image = 'yomama/' . $records[$i]['image'] : $image = 'images/blondes.gif'; 
                                                                                                        echo '<a class="pagelink" href="/yomama/'. $records[$i]['id'] .'"><img src="/img/'.$image.'" border="0" width="65" height="65" /></a>';
												?>
								...
								<tr>
									<td align="center">
										...
										<b><?php echo '<a class="pagelink" href="/yomama/'. $records[$i]['id'] .'">'.$records[$i]['catname'].'</a>';?></b>
									</td>
								</tr>
							</table>
							</td>
