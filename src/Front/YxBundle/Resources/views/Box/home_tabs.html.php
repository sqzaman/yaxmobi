			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="10" style="background-image: url(/img/images/t02.gif); background-repeat: repeat-x;">
						<a href="/tabs/index/"  class="navwhitelink change-tab" id="link1001890292" >Audio&nbsp;Jokes</a></td>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<table border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											<td bgcolor="#eeeeee">
												<?php
													$songcat[$i]['image'] != '' ? $image = 'genres/' . $songcat[$i]['image'] : $image = 'images/blondes.gif'; 
                                                                                                        echo '<a class="pagelink" href="/songs/genre/'. $songcat[$i]['id'] .'"><img src="/img/'.$image.'" border="0" width="65" height="65" /></a>';
												?>
								...
								<tr>
									<td align="center">
										...
										<b><?php echo '<a class="pagelink" href="/songs/genre/'. $songcat[$i]['id'] .'">'.$songcat[$i]['gname'].'</a>';?></b>
									</td>
								</tr>
							</table>
							</td>
