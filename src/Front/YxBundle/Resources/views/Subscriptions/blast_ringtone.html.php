            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="10" style="background-image: url('/img/images/t02d.gif'); background-repeat: repeat-x;">
                        <a href="/subscriptions/ringtone_subscription/1/" class="navgraylink change-tab">Tickle</a>
                    </td>
                    <td width="1">
                        <img src="/img/images/t03d.gif" border="0" width="6" height="28" />
                    </td>
                    <td width="2">&nbsp;</td>
                    <td width="1">
                    ...
                    <td width="10" style="background-image: url('/img/images/t02.gif'); background-repeat: repeat-x;">
                        <a href="/subscriptions/ringtone_subscription/2/" class="navwhitelink change-tab">Blast</a>
                    </td>
                    <td width="1">
    ...
    <tr>
        ...
        if (intval($users['id_subscript']) == 0) {
            ...
            ?> 
                                                                        ...
                                                                        <input type="hidden" name="item_name" value="Subscription <?= $plan[$i]['name'] ?>"> 
