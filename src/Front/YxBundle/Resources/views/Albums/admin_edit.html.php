            ...
            <table width="70%" cellpadding="2" cellspacing="0" border="0" align="" class="blue_header borNavBlue">
                ...
                <tr class="bgGrey">
                    ...
                    <td>
                        ...
                        <input class="required" type="text" size="40" name="aname" value="<?php echo $album->getAname(); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input class="required" type="text" size="40" name="description" value="<?php echo $album->getDescription(); ?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right">Album Price:</td>
                    <td>
                        <input class="required" type="text" size="40" name="price" value="<?php echo $album->getPrice(); ?>" />
                    </td>
                </tr>
                <tr class="bgGrey">
                    <td align="right"></td>
