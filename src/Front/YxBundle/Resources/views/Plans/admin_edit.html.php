...
<div class="PageTitle"><?php echo strtoupper('Edit Plan'); ?></div>
<div id="tasks_todo" >
    <div class="md">
            ...
            <table width="70%" cellpadding="2" cellspacing="0" border="0" align="" class="blue_header borNavBlue">
                ...
                <tr class="bgGrey">
                    ...
                    <td>
                        ...
                        <input class="required" type="text" size="40" name="planname" value="<?php echo $record->getPlanname();?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right">Plan Cost:</td>
                    <td>
                        <input class="required" type="text" size="40" name="plancost" value="<?php echo $record->getPlancost() ;?>" />
                    </td>
